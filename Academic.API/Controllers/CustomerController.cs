...
namespace careapi.Controllers
{
    ...
    public class CustomerController : ApiController
    {
        ...
        public CustomerController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]CustomerVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Customer.CreateCustomerAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Customer.GetCustomer(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int customerId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Customer.GetCustomerById(customerId,tenantId);
        ...
        public async Task<IHttpActionResult> Get(int customerId)
        {
            ...
            {   
                ...
                var result = await _wrapper.Customer.GetCustomer(customerId, tenantId);
        ...
        [HttpPut]
		[Route("{customerId}/customerId")]
        public async Task<IHttpActionResult> Update([FromBody]CustomerVM model, int customerId)
        {
            try
            {
                var result = await _wrapper.Customer.UpdateCustomer(customerId, model);
        ...
        public async Task<IHttpActionResult> Delete(int customerId)
        {
            try
            {
                var result = await _wrapper.Customer.DeleteCustomer(customerId);
