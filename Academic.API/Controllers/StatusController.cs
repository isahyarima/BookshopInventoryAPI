...
namespace careapi.Controllers
{
    ...
    public class StatusController : ApiController
    {
        ...
        public StatusController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]StatusVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Status.CreateStatusAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Status.GetStatus(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int statusId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Status.GetStatusById(statusId,tenantId);
        ...
        [HttpGet]
        [Route("{statusId}/statusId")]
        public async Task<IHttpActionResult> Get(int statusId)
        {
            try
            {   
                                   var tokenIdentity = new ClaimsIdentity(HttpContext.Current.User.Identity);
                ...
                var result = await _wrapper.Status.GetStatus(statusId, tenantId);
        ...
        [HttpPut]
		[Route("{statusId}/statusId")]
        public async Task<IHttpActionResult> Update([FromBody]StatusVM model, int statusId)
        {
            try
            {
                var result = await _wrapper.Status.UpdateStatus(statusId, model);
        ...
        [HttpDelete]
		[Route("{statusId}/statusId")]
        public async Task<IHttpActionResult> Delete(int statusId)
        {
            try
            {
                var result = await _wrapper.Status.DeleteStatus(statusId);
