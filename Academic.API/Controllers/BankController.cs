...
namespace careapi.Controllers
{
    ...
    public class BankController : ApiController
    {
        ...
        public BankController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]BankVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Bank.CreateBankAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Bank.GetBank(tenantId);
		...
		[HttpGet]
        [Route("{bankId}/bankId")]
        public async  Task<IHttpActionResult> GetById(int bankId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Bank.GetBankById(bankId,tenantId);
        ...
        [HttpGet]
        [Route("{bankId}/bankId")]
        public async Task<IHttpActionResult> Get(int bankId)
        {
            try
            {   
                                   var tokenIdentity = new ClaimsIdentity(HttpContext.Current.User.Identity);
                ...
                var result = await _wrapper.Bank.GetBank(bankId, tenantId);
        ...
        [HttpPut]
		[Route("{bankId}/bankId")]
        public async Task<IHttpActionResult> Update([FromBody]BankVM model, int bankId)
        {
            try
            {
                var result = await _wrapper.Bank.UpdateBank(bankId, model);
        ...
        [HttpDelete]
		[Route("{bankId}/bankId")]
        public async Task<IHttpActionResult> Delete(int bankId)
        {
            try
            {
                var result = await _wrapper.Bank.DeleteBank(bankId);
