...
namespace careapi.Controllers
{
    ...
    public class EmployeeController : ApiController
    {
        ...
        public EmployeeController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]EmployeeVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Employee.CreateEmployeeAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Employee.GetEmployee(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int employeeId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Employee.GetEmployeeById(employeeId,tenantId);
        ...
        public async Task<IHttpActionResult> Get(int employeeId)
        {
            ...
            {   
                ...
                var result = await _wrapper.Employee.GetEmployee(employeeId, tenantId);
        ...
        [HttpPut]
		[Route("{employeeId}/employeeId")]
        public async Task<IHttpActionResult> Update([FromBody]EmployeeVM model, int employeeId)
        {
            try
            {
                var result = await _wrapper.Employee.UpdateEmployee(employeeId, model);
        ...
        public async Task<IHttpActionResult> Delete(int employeeId)
        {
            try
            {
                var result = await _wrapper.Employee.DeleteEmployee(employeeId);
