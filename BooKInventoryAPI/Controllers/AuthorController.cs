...
namespace careapi.Controllers
{
    ...
    public class AuthorController : ApiController
    {
        ...
        public AuthorController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]AuthorVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Author.CreateAuthorAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Author.GetAuthor(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int authorId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Author.GetAuthorById(authorId,tenantId);
        ...
        [HttpGet]
        [Route("{authorId}/authorId")]
        public async Task<IHttpActionResult> Get(int authorId)
        {
            try
            {   
                                   var tokenIdentity = new ClaimsIdentity(HttpContext.Current.User.Identity);
                ...
                var result = await _wrapper.Author.GetAuthor(authorId, tenantId);
        ...
        [HttpPut]
		[Route("{authorId}/authorId")]
        public async Task<IHttpActionResult> Update([FromBody]AuthorVM model, int authorId)
        {
            try
            {
                var result = await _wrapper.Author.UpdateAuthor(authorId, model);
        ...
        public async Task<IHttpActionResult> Delete(int authorId)
        {
            try
            {
                var result = await _wrapper.Author.DeleteAuthor(authorId);
