...
namespace careapi.Controllers
{
    ...
    public class RoleController : ApiController
    {
        ...
        public RoleController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]RoleVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Role.CreateRoleAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Role.GetRole(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int roleId)
        {
            try
            {
                ...
                var result = await _wrapper.Role.GetRoleById(roleId,tenantId);
        ...
        public async Task<IHttpActionResult> Get(int roleId)
        {
            ...
            {   
                ...
                var result = await _wrapper.Role.GetRole(roleId, tenantId);
        ...
        [HttpPut]
		[Route("{roleId}/roleId")]
        public async Task<IHttpActionResult> Update([FromBody]RoleVM model, int roleId)
        {
            try
            {
                var result = await _wrapper.Role.UpdateRole(roleId, model);
        ...
        public async Task<IHttpActionResult> Delete(int roleId)
        {
            try
            {
                var result = await _wrapper.Role.DeleteRole(roleId);
