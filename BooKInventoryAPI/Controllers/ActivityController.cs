...
{
    [RoutePrefix("api/v1/activity")]
    [Authorize]
    public class ActivityController : ApiController
    {
        private readonly IWrapperRepository _wrapper;
        public ActivityController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]ActivityVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Activity.CreateActivityAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Activity.GetActivity(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int activityId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Activity.GetActivityById(activityId,tenantId);
        ...
        [HttpGet]
        [Route("{activityId}/activityId")]
        public async Task<IHttpActionResult> Get(int activityId)
        {
            try
            {   
                                   var tokenIdentity = new ClaimsIdentity(HttpContext.Current.User.Identity);
                ...
                var result = await _wrapper.Activity.GetActivity(activityId, tenantId);
        ...
        [HttpPut]
		[Route("{activityId}/activityId")]
        public async Task<IHttpActionResult> Update([FromBody]ActivityVM model, int activityId)
        {
            try
            {
                var result = await _wrapper.Activity.UpdateActivity(activityId, model);
        ...
        [HttpDelete]
		[Route("{activityId}/activityId")]
        public async Task<IHttpActionResult> Delete(int activityId)
        {
            try
            {
                var result = await _wrapper.Activity.DeleteActivity(activityId);
