...
{
    [RoutePrefix("api/v1/supplier")]
    [Authorize]
    public class SupplierController : ApiController
    {
        private readonly IWrapperRepository _wrapper;
        public SupplierController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]SupplierVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Supplier.CreateSupplierAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Supplier.GetSupplier(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int supplierId)
        {
            try
            {
                int tenantId = 0;
                ...
                var result = await _wrapper.Supplier.GetSupplierById(supplierId,tenantId);
        ...
        public async Task<IHttpActionResult> Get(int supplierId)
        {
            ...
            {   
                ...
                var result = await _wrapper.Supplier.GetSupplier(supplierId, tenantId);
        ...
        [HttpPut]
		[Route("{supplierId}/supplierId")]
        public async Task<IHttpActionResult> Update([FromBody]SupplierVM model, int supplierId)
        {
            try
            {
                var result = await _wrapper.Supplier.UpdateSupplier(supplierId, model);
        ...
        public async Task<IHttpActionResult> Delete(int supplierId)
        {
            try
            {
                var result = await _wrapper.Supplier.DeleteSupplier(supplierId);
