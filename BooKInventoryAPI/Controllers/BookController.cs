...
namespace careapi.Controllers
{
    ...
    public class BookController : ApiController
    {
        ...
        public BookController(IWrapperRepository wrapper)
        {
            _wrapper = wrapper;
        }
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> Create([FromBody]BookVM model)
        {
            try
            {
                ...
                var result = await _wrapper.Book.CreateBookAsync(model);
        ...
        public async  Task<IHttpActionResult> Get()
        {
            try
            {
                ...
                var result = await _wrapper.Book.GetBook(tenantId);
        ...
        public async  Task<IHttpActionResult> GetById(int bookId)
        {
            try
            {
                ...
                var result = await _wrapper.Book.GetBookById(bookId,tenantId);
        ...
        [HttpGet]
        [Route("{bookId}/bookId")]
        public async Task<IHttpActionResult> Get(int bookId)
        {
            try
            {   
                                   var tokenIdentity = new ClaimsIdentity(HttpContext.Current.User.Identity);
                ...
                var result = await _wrapper.Book.GetBook(bookId, tenantId);
        ...
        [HttpPut]
		[Route("{bookId}/bookId")]
        public async Task<IHttpActionResult> Update([FromBody]BookVM model, int bookId)
        {
            try
            {
                var result = await _wrapper.Book.UpdateBook(bookId, model);
        ...
        public async Task<IHttpActionResult> Delete(int bookId)
        {
            try
            {
                var result = await _wrapper.Book.DeleteBook(bookId);
